...
- [Project Setup and Build](#project-setup-and-build)
  ...
  * [Setup for lazy loading elements](#setup-for-lazy-loading-elements)
  * [Setup for Angular material](#setup-for-angular-material)
  * [Setup for Angular Dynamic Forms](#setup-for-angular-dynamic-forms)
- [Working ChangeDetection](#working-changedetection)
  * [Zone-less](#zone-less)
    + [Setup Running Zone-Less](#setup-running-zone-less)
    + [Problems when Running Zone Less](#problems-when-running-zone-less)
  ...
  * [Zone-full](#zone-full)
    ...
    + [Restoreable-Zones](#restoreable-zones)
- [Developer Workflow](#developer-workflow)
  * [Development](#development)
  * [Deployment/Bundling](#deploymentbundling)
    + [Setup zone-full build and serve](#setup-zone-full-build-and-serve)
    + [Setup zone-less build](#setup-zone-less-build)
    + [Setup un-compiled build](#setup-un-compiled-build)
- [Loading strategies](#loading-strategies)
  * [Elements Bundled with App](#elements-bundled-with-app)
  * [Elements Precompiled Lazy Loaded](#elements-precompiled-lazy-loaded)
  * [Elements Uncompiled Lazy Loaded](#elements-uncompiled-lazy-loaded)
